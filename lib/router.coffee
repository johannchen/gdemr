...
Router.route '/patients/:_id/diagnoses', ->
	@render 'patientDiagnoses',
		data:
			pid: @params._id

Router.route '/patients/:_id/surgeries', ->
	@render 'patientSurgeries',
		data:
			pid: @params._id

Router.route '/patients/:_id/behaviors', ->
	@render 'patientBehaviors',
		data:
			pid: @params._id
